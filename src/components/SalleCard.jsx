      ...
      <div className="w-[343.97px] h-[465px] bg-white rounded-xl relative">
        ...
        <div className="w-[281.89px] mx-auto mt-5">
          <div className="flex justify-between">
            ...
            <h2 className="font-Poppins text-2xl font-bold tracking-wider text-nowrap">
              {hourPrice} $/h
            </h2>
          </div>
          ...
          <div className="absolute right-3 bottom-5 w-fit bg-primary py-2 px-3 rounded-full">
            <a
              href="#"
